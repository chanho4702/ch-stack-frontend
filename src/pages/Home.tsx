...
const cards: HubCard[] = [
  {
    to: '/login',
    title: '내 서비스 (로그인 → 대시보드)',
    description: 'src/app 의 실제 서비스 골격. 로그인 → 보호된 /app 대시보드 + 게시판(목록·글쓰기·수정·삭제). (데모: 형식만 맞으면 통과)',
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
        <Stack spacing={1.5} sx={{ mb: 6, maxWidth: 720 }}>
          ...
          <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 400 }}>
            MUI v9 기반 작업 공간. 내 서비스는 <code>src/app</code> 에서 만들고, 참고용 MUI
            공식 템플릿은 <code>src/context/templates</code> 에 그대로 보관돼 있습니다.
          </Typography>
        </Stack>
